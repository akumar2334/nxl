...
import { TrendingUp, Users, Target, Calendar, Zap } from "lucide-react";
...
// Skeleton Loader (simple but effective)
const SkeletonCard = () => (
...
const Analytics = () => {
  const isLoading = false; // simulate if needed
    ...
    <main className="bg-gray-50 min-h-screen px-3 sm:px-6 lg:px-8 py-4 sm:py-6 space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div className="lg:col-span-2 bg-white border border-gray-100 rounded-xl p-4">
          ...
          <div className="h-56 sm:h-64 bg-gray-50 border border-dashed border-gray-200 rounded-lg flex items-center justify-center text-gray-400 text-sm">
            Chart Placeholder
          </div>
        </div>
