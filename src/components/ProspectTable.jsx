    ...
    <>
      ...
      <div className="hidden sm:grid grid-cols-12 items-center px-4 py-4 border-b border-gray-100 hover:bg-indigo-50/30 transition">
        ...
        <div className="col-span-3 flex items-start gap-3">
          <div className={`w-9 h-9 rounded-full flex items-center justify-center text-white text-xs font-semibold ${p.avatarColor}`}>
            {p.initials}
          </div>
          ...
          <div>
            ...
            <div className="flex items-center gap-2 mt-1">
              <div className={`w-4 h-4 rounded-sm flex items-center justify-center text-[10px] text-white ${p.companyColor}`}>
                {p.companyInitial}
              </div>
